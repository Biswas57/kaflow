...
public class TributaryTestComplex {
    ...
    public void mainComplexTest() {
        ...
        assertSame(controller.getConsumerGroup("bananaChefs").getConsumer("beginnerChef1").listAssignedPartitions()
        ...
        if (controller.findPartition("bananaCookingMethod1").listMessages().size() >= 3) {
            ...
            assertAll(
                    ...
                    () -> assertDoesNotThrow(() -> controller.createEvent("bananaFrier", "banana", "bananaFryNums",
                            "bananaCookingMethod1")),
                    () -> assertDoesNotThrow(() -> controller.createEvent("bananaFrier", "banana", "bananaFryTemp",
                            "bananaCookingMethod1")),
                    () -> assertDoesNotThrow(() -> controller.createEvent("bananaFrier", "banana", "bananaFryDur",
                            "bananaCookingMethod1")));
        }
