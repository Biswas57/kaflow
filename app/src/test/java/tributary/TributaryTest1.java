...
// assertEquals(cluster.getConsumerGroup("bananaChefs").listConsumers().size(),
// 2);
// assertThrows(IOException.class, () -> {
// controller.createEvent("bananaBoiler", "banana", "noBanana",
...
// });
// assertEquals(1,
// cluster.getTopic("banana").getPartition("bananaCookingMethods").listMessages().size());
...
// });
// assertEquals(1,
// cluster.getTopic("banana").getPartition("bananaCookingStyles").listMessages().size());
...
// () -> assertEquals(1,
// helper.findConsumer("beginnerChef").listAssignedPartitions().size()));

// // After deleting the consumer, the partition should be reassigned to the
// other
...
// Partition<String> partition = (Partition<String>)
// helper.findPartition("bananaCookingMethods");
// Consumer<String> consumer = (Consumer<String>)
// helper.findConsumer("beginnerChef");
