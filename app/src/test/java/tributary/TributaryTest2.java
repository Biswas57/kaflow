...
// import static
// com.github.stefanbirkner.systemlambda.SystemLambda.assertNothingWrittenToSystemErr;
// import static
...
// controller.createTopic("pingu", "GARBO!"));

// // Partition creation - errors
// text = tapSystemOut(() -> {
// controller.createPartition("banana", "bananaCookingMethod1");
// });
// assertEquals("Partition bananaCookingMethod1 already exists in topic.",
// text.strip());
// text = tapSystemOut(() -> {
...
// assertEquals(0,
// cluster.getConsumerGroup("bananaChefs").listConsumers().size());
// assertSame(helper.getConsumerGroup("bananaChefs").getRebalanceMethodName(),
// RangeStrategy.class.getSimpleName());

// controller.createConsumerGroup("bananaChefs", "banana", "range");
// assertEquals(1, cluster.listConsumerGroups().size()); // Consumer Group
// already exists
...
// () -> assertDoesNotThrow(
// () -> controller.createEvent("bananaBoiler", "banana", "bananaBoilingNums",
// null)),
// () -> assertDoesNotThrow(
// () -> controller.createEvent("bananaBoiler", "banana", "bananaBoilingTemp",
// null)),
// () -> assertDoesNotThrow(
// () -> controller.createEvent("bananaBoiler", "banana", "bananaBoilingDur",
// null)),
// () -> assertDoesNotThrow(
...
// "bananaCookingMethod1")),
// () -> assertThrows(IllegalArgumentException.class,
// () -> controller.createEvent("bananaFrier", "banana", "fryBanana",
// "bananaCookingMethod3")));

// // Consumer offset setup and event consumption
// String partitionId = "bananaCookingMethod1";
// String consumerId = "beginnerChef1";
// Partition<Integer> partition = (Partition<Integer>)
// helper.findPartition(partitionId);
// Consumer<Integer> consumer = (Consumer<Integer>)
// helper.findConsumer(consumerId);
...
// String[] produceArgs = { "bananaFrier", "banana", "bananaFryNums",
// partitionId, "bananaFrier", "banana",
// "bananaFryDur", partitionId };
// assertNothingWrittenToSystemErr(() ->
// controller.parallelProduce(produceArgs));
...
// assertEquals(partition.listMessages().size() - 1,
// partition.getOffset(consumer));
...
// () -> assertEquals(partition.listMessages().size() - 1,
// partition.getOffset(consumer)),
// () -> assertDoesNotThrow(() -> controller.consumeEvents("beginnerChef1",
// partitionId, 1)),
// () -> assertEquals(partition.listMessages().size(),
// partition.getOffset(consumer)));
// }
// }
