...
class TypeHandlerTest {
    ...
    void testStringHandler() {
        ...
        assertEquals(message, convertedBack, "String conversion to long and back should preserve value");
        ...
        assertEquals(utf8String.substring(0, Math.min(utf8String.length(), 8)), convertedBack.trim(),
    ...
    void testIntegerHandler() {
        ...
        assertEquals(number, convertedBack, "Integer conversion to long and back should preserve value");
    }
    ...
    void testByteHandler() {
        ...
        assertArrayEquals(byteArray, convertedBack, "Byte array conversion to long and back should preserve value");
        ...
        assertArrayEquals(utf8Bytes, convertedBack, "UTF-8 byte array conversion should preserve value");
    }

    @Test
    void testTypeHandlerFactory() {
        TypeHandler<Integer> integerHandler = TypeHandlerFactory.getHandler(Integer.class);
        TypeHandler<String> stringHandler = TypeHandlerFactory.getHandler(String.class);
        TypeHandler<byte[]> byteArrayHandler = TypeHandlerFactory.getHandler(byte[].class);

        assertNotNull(integerHandler, "TypeHandlerFactory should return an IntegerHandler for Integer.class");
        assertNotNull(stringHandler, "TypeHandlerFactory should return a StringHandler for String.class");
        assertNotNull(byteArrayHandler, "TypeHandlerFactory should return a ByteHandler for byte[].class");
