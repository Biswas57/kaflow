...
// String decryptedMessage = encryptionManager.decrypt(encryptedMessage,
// publicKey);

// assertEquals(message, decryptedMessage, "Decryption should recover the
// original message");
// }
...
// assertEquals(1, EncryptionManager.modularExponentiation(5, 0, 13), "Any
// number^0 mod N should be 1");
// assertEquals(0, EncryptionManager.modularExponentiation(0, 5, 13), "0^exp mod
// N should be 0");
...
// assertEquals(1, EncryptionManager.modularInverse(1, 13), "Modular inverse of
// 1 mod any number should be 1");
// assertThrows(ArithmeticException.class, () ->
// EncryptionManager.modularInverse(2, 4),
...
// assertEquals(1, PrimeNumGenerator.gcd(n, coprime), "Generated coprime should
...
// assertEquals(1, PrimeNumGenerator.gcd(n, coprime), "Generated coprime for n=2
// should have a GCD of 1 with n");
// }

// @Test
// void testGCD() {
// assertEquals(5, PrimeNumGenerator.gcd(35, 10), "GCD of 35 and 10 should be
// 5");
// assertEquals(1, PrimeNumGenerator.gcd(17, 4), "GCD of 17 and 4 should be 1
// (coprime)");
...
// assertNotEquals(originalMessage, encryptedMessage, "Encrypted message should
// differ from the original message");
// String decryptedMessage = encryptionManager.decrypt(encryptedMessage,
// publicKey);
// assertEquals(originalMessage, decryptedMessage, "Decryption should correctly
...
// String message = "This is a test message with multiple words and numbers:
// 1234567890";
...
// "Complex123StringWith@Special#Characters&More1234567890Symbols%$*";
